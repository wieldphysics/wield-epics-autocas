...
class LJUE9ADCRelay(service.LJIORelay):
    ...
    def raw_read(self, lj, result):
        ...
        self.rv_ADC.value = lj.binaryToCalibratedAnalogVoltage(ain, self.BipGain, self.Resolution)
        return
...
class LJUE9TempRelay(LJUE9ADCRelay):
    ...
    def raw_read(self, lj, result):
        ...
        self.rv_ADC.value = lj.binaryToCalibratedAnalogTemperature(ain, self.BipGain, self.Resolution)
        return
