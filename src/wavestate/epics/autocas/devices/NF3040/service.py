...
class NF3040Ebridge(epics.EpicsRelayUser):
    ...
    def augment_medm(self, pvs_by_part, extra_replace, prefix = ''):
        super(NF3040Ebridge, self).augment_medm(pvs_by_part, extra_replace, prefix = prefix)
...
class NF3040Runner(
    ...
    def medm_full_panel(self):
        ...
        medm.medm_screen_filename_from_namechain(self.ebridge.egroup.name_chain.child('FPANEL'))
        return medm
