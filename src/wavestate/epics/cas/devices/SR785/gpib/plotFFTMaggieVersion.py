...
def parse_commandline():
  ...
  parser.add_option("-o", "--outputDir",
                    default="../../../Data/"+datetime.now().strftime("%Y-%m-%d"),
  ...
  parser.add_option("-p", "--FFTSR785",default="./FFTSR785Maggie.py",help="Path to the FFTSR785.py.")
  parser.add_option("--nocombine",dest="nocombine",action='store_true',
  ...
  parser.add_option("-i", "--ip",
                  dest="ipAddress", default="18.120.0.98",
  ...
  parser.add_option("--base", dest="base",action="store_true", 
                  default="False",
  ...
  parser.add_option("--dB", action="store_true", default="False",
                  dest="decible",
