...
class EpicsIndirectController(
    ...
    def chn_cb_in(self, value):
        ...
        if self._chn_link_in is not None:
            self._chn_link_in.state_connect.bool_register(self.state_connect_epics, remove = True)
    ...
    def chn_cb_out(self, value):
        if self._chn_link_out is not None:
            self._chn_link_out.state_connect.bool_register(self.state_connect_epics, remove = True)
