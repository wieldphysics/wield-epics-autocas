...
class LJT7ADCRelay(LJIORelay):
    ...
    def raw_read(self, lj, result):
        ...
        self.ebridge.rv_ADC.value = lj.binaryToCalibratedAnalogVoltage(ain, self.BipGain, self.Resolution)
        return
...
class LJT7TempRelay(LJT7ADCRelay):
    ...
    def raw_read(self, lj, result):
        ...
        self.ebridge.rv_ADC.value = lj.binaryToCalibratedAnalogTemperature(ain, self.BipGain, self.Resolution)
        return
