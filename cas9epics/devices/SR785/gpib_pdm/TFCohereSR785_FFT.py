...
trig_source = {0: "Continuous", 1: "Ch1", 2: "Ch2", 3: "External", 4: "Ext. TLL", 
                   5: "Source", 6: "Manual"}[i]
trig_level = gpibObj.query("TLVL?")[:-3]+"%" # Trigger level in percent-->May have problems if not returned as percent
