...
ser = serial.Serial('/dev/ttyUSB1',  baudrate=9600, bytesize=8, parity='N', stopbits=1, timeout=2, xonxoff=0, rtscts=0)
print(ser)
...
re_LEVELVALUE = re.compile('^:RFLV:UNITS DBM;TYPE PD;VALUE ({0});INC {0};(ON|OFF)$'.format(float_re))
