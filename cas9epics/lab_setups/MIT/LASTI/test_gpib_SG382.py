...
re_FREQVALUE = re.compile('^:CFRQ:VALUE ({0});INC {0};MODE (?:FIXED|SWEPT)$'.format(float_re))
re_LEVELVALUE = re.compile('^:RFLV:UNITS DBM;TYPE PD;VALUE ({0});INC {0};ON$'.format(float_re))
